...
class IDLE:
    ...
    def draw(self):
        ...
        if self.face_dir == 1:
            self.image.clip_draw(int(self.frame) * 182, (336 - ( 168 * ypos )) ,
                                 183, 168, self.x, self.y)
        else:
            self.image.clip_composite_draw(int(self.frame) * 183, (336 - ( 168 * ypos )), 182, 168,
                                           0, 'h', self.x, self.y, 183, 168)
...
next_state = {
    IDLE:  {RU: IDLE,  LU: IDLE,  RD: IDLE,  LD: IDLE, TIMER: IDLE, SPACE: IDLE},
